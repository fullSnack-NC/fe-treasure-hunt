...
const Locations = ({ navigation }) => {
  ...
  return (
    <View
      ...
      accessible={true}
      accessibilityLabel={'Hunt Location Page'}
    >
      <ImageBackground
            ...
            {locations.map((location) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  imageStyle={styles.image_imageStyle}
                  accessible={true}
                  accessibilityLabel={`${location.park_name}`}
                  accessibilityHint={'Click to select this park'}
                    ...
                    <View style={cardStyles.cardBody}>
                      <View style={cardStyles.bodyContent}>
                        <Text
                          ...
                          accessible={true}
                          accessibilityLabel={`Park Name ${location.park_name}`}
                        >
                          {location.park_name}
                        </Text>
                        <View
                          style={cardStyles.subtitleStyle}
                          accessible={true}
                          accessibilityLabel={'Park amenities'}
                        >
                      ...
                      <Image
                        ...
                        imageStyle={styles.image_imageStyle}
                        accessible={true}
                        accessibilityLabel={`${location.park_name} image`}
